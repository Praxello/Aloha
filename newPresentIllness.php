<div class="modal fade full-window-modal" id="presentIllness" tabindex="-1" role="dialog" aria-labelledby="fullwindowModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <input type="text" class="form-control" id="pulse" placeholder="pulse" name="pulse">
                                                                    </div>
