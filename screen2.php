                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                        <textarea placeholder="abc" class="form-control" name="chief"></textarea>
                                                                    </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                           <div class="col-md-3">
                                                                <div class="form-group">
                                                                 <label for="">Chest :</label><br>
                                                <label for="">Added Sound :</label><br>
                                                <label for="">Wheeze Rhonchi :</label><br>
                                                <label for="">Dyspnoea :</label><br>
                                                                </div>
                                                            </div>
                                                    </div>
                                                </div>
                                               ...
                                               <!--  <div class="col-md-4">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                           <div class="col-md-3">
                                                                <div class="form-group">
                                                              <label for="">s1,s2 heard :</label><br>
                                                                <label for="">Murmur :</label><br>
                                                                </div>
                                                            </div>
                                                    </div>
                                                </div>
                                                         ...
                                                         <!--    <div class="col-md-1">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="10"
                                                                        class="form-control" name="rthigh"
                                                                        id="rthigh">
                                                                </div>
                                                            </div> -->
                                                         <!--    <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="10"
                                                                        class="form-control" name="lthigh"
                                                                        id="lthigh">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="10"
                                                                        class="form-control" name="whipratio"
                                                                        id="whipratio">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="10"
                                                                        class="form-control" name="fmember"
                                                                        id="fmember">
                                                                </div>
                                                            </div> -->
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                           <div class="col-md-4">
                                                                <div class="form-group">
                                                                 <label for="">Conciousness :</label><br>
                                                <label for="">U.M.N Reflex:</label><br>
                                                <label for="">L.M.N Reflex :</label><br>
                                                <label for="">Reflexes :</label><br>
                                                                </div>
                                                            </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                           <div class="col-md-4">
                                                                <div class="form-group">
                                                              <label for="">Photosensivity :</label><br>
                                                                <label for="">Rash :</label><br>
                                                                  <label for="">Site :</label><br>
                                                                    <label for="">Type :</label><br>
                                                                      <label for="">Itching :</label><br>
                                                                </div>
                                                            </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                           <div class="col-md-4">
                                                                <div class="form-group">
                                                              <label for="">Oral Mucosa :</label><br>
                                                                <label for="">Scalp :</label><br>
                                                                  <label for="">Nodules :</label><br>
                                                                    <label for="">Eyes :</label><br>
                                                                      <label for="">Raynaud's :</label><br>
                                                                        <label for="">Telangiectasia :</label><br>
                                                                </div>
                                                            </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-2">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="10"
                                                                        class="form-control" name="spo2"
                                                                        id="spo2">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="">HB1C</label>
                                                                    <input type="text" placeholder="10"
                                                                        class="form-control" name="hb1c"
                                                                        id="hb1c">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="">FBS</label>
                                                                    <input type="text" placeholder="10"
                                                                        class="form-control" name="fbs"
                                                                        id="fbs">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="">PPBS</label>
                                                                    <input type="text" placeholder="10"
                                                                        class="form-control" name="ppbs"
                                                                        id="ppbs">
                                                                </div>
                                                            </div>
                                                             <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="">GFR</label>
                                                                    <input type="text" placeholder="10"
                                                                        class="form-control" name="gfr"
                                                                        id="gfr">
                                                                </div>
                                                            </div>
                                                              <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="">Goal Wt</label>
                                                                    <input type="text" placeholder="10"
                                                                        class="form-control" name="gwt"
                                                                        id="gwt">
                                                                </div>
                                                            </div>
                                                              <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="">BMI</label>
                                                                    <input type="text" placeholder="NAN"
                                                                        class="form-control" name="bmi"
                                                                        id="bmi">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">                                                            
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="01"
                                                                        class="form-control" name="vveins"
                                                                        id="vveins">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="01"
                                                                        class="form-control" name="imenses"
                                                                        id="imenses">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="01"
                                                                        class="form-control" name="thyroiddisorder"
                                                                        id="thyroiddisorder">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="01"
                                                                        class="form-control" name="constipation"
                                                                        id="constipation">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="01"
                                                                        class="form-control" name="backache"
                                                                        id="backache">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="01"
                                                                        class="form-control" name="acidity"
                                                                        id="acidity">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="01"
                                                                        class="form-control" name="hdisease"
                                                                        id="hdisease">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="01"
                                                                        class="form-control" name="dislipidemia"
                                                                        id="dislipidemia">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="01"
                                                                        class="form-control" name="breathlessness"
                                                                        id="breathlessness">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="01"
                                                                        class="form-control" name="bloating"
                                                                        id="bloating">
                                                                </div>
                                                            </div>                                                            
                                                        </div>
