                            ...
                            <div class="card">
                                ...
                                <div class="card-body template-demo">
                                    ...
                                    <button type="button" class="btn btn-danger" data-toggle="modal"
                                        data-target="#fullwindowModal">Add Diet Information</button>
                                </div>
                            </div>
                            <!-- <div class="card">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" placeholder=""
                                                                                class="form-control" name="scraving"
                                                                                id="scraving">
                                                                        </div>
                                                                    </div>   
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <span>/Month</span><input type="text" placeholder="" class="form-control" name="oconsumption" id="oconsumption">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="">Tea/Coffee</label>
                                                        <span>/Month</span><input type="text" placeholder="tea" class="form-control" name="teacoffee" id="teacoffee">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
