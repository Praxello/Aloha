...
if(isset($_POST['fromDate']) && isset($_POST['uptoDate'])){
    $sql = "SELECT cc.callId,cc.clientId,cc.callDateTime,cc.branchId,cc.doctorId,cc.disease,cc.appointmentDate,DATE_FORMAT(cc.appointmentDate,'%W %d %b %Y-%H:%i:%s') appointment,
    cc.remarks,cc.folowupNeeded,cc.attendedBy,cc.callStatus,cc.feedback,st.name AS stateName,ct.name AS cityName,cc.folowupNeededDateTime follow,
