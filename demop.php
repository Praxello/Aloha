                                                                                                                        ...
                                                                                                                        <div class="row">
                                                                                                                            <div class="col-md-12">
                                                                                                                                <article> I
                                                                                                                                    ...
                                                                                                                                    <input type="text" name="" id="">since
                                                                                                                                    <input type="text" name="" id=""> .I have appraoached Lokmanya Hospitals for the treament of the same.</article>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                        <div class="row">
                                                                                                                            <div class="col-md-12">
                                                                                                                                <article>I am aware that my complaints is lifestyle based / degenerative in nature that has accumulated over time due to a wrong lifestyle / posture / age factors, etc. The doctor / therapist has examined me and expained about problems and treatment options.</article>
                                                                                                                            </div>
                                                                                                                        </div>

                                                                                                                        <article>I am aware that non-surgical and / or complementory and alternative methods require its own course of times as they offer progressive wellness and relief.
                                                                                                                            <br> I have been explained clearly and properly by the doctors / staff of the therapeutic centre, about the treatment options, indications ad contra-indications.
                                                                                                                            <br>
                                                                                                                            <br> </article>

                                                                                                                        <article>I shall abstain from physical and mental stress. I was explained and am aware from counseling that non-invasive, alternative and holistic treatment aproaches
                                                                                                                            <br> offered has a success rae of 80-90%. I am aware and agree that there are chances that i may not get benefit from the therapy due to any underlying anatomical /
                                                                                                                            <br> physiological / lifestyle / medical conditions.</article>

                                                                                                                        <article>I agree with good conscience to undergo the therapy / program offered. I will not hold responsible doctor /
                                                                                                                            <br> therapist / technisian / other staff for the treatment results. I assure completed co-operation to the doctor / therapist during the course of the treatment.
                                                                                                                            <br> Along with following the prescibed treatment / excercise, leading to an improved proper lifestyle. </article>
                                                                                                                    </div>
                                                                                                                </div>
