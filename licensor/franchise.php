    ...
    <body>
        <div class="wrapper">
            ...
            <div class="page-wrap">
                ...
                <?php include 'lisidebar.php';?>
                <div id="editbranchNew"></div>
                <div class="main-content template-demo " id="newData">
                
                <button class="btn btn-success" type="button" style="float: right;margin-bottom: 10px;" data-toggle="modal" data-target="#branchModal">Add New Franchise</button>
        ...
        <?php include 'add-franchise.php';?>
        <script src="../js/charts.js"></script>
        <script src="../dist/js/theme.min.js"></script>
       <script src="../jscode/franchise.js"></script>
    </body>
</html>
<?php
}else{
