                                    ...
                                    <form id="callRegister">
                                        <div class="card-header row">
                                                ...
                                                <div class="form-group">
                                                    <a href="spine_reports.php" target="_blank" class="btn btn-link btn-primary">Download report</a>
                                                    <!-- <button class="btn btn-link btn-primary" href="../spine_reports.php" type="button" id="searchCollection">Download report</button> -->
                                                </div>
